...
<nav class="navbar navbar-expand-lg bg-body-tertiary rounded-3 shadow-sm mb-3">
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center gap-2">
            <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/BirreCreateServlet?action=nuovo">
                <i class="fa fa-plus-circle"></i> Aggiungi Birra
            </a>
        ...
        <div class="collapse navbar-collapse mt-2 mt-lg-0" id="prodFilters">
            ...
            <form class="ms-auto d-flex gap-2 align-items-center"  method="GET" action="${pageContext.request.contextPath}/BirreListServlet">               
                ...
                <div class="input-group input-group-sm" style="min-width: 240px;">
                    ...
                    <input type="text" class="form-control" name="stile"                           
                           value="${param.stile}">
                </div>
                ...
                <a class="btn btn-outline-secondary btn-sm"
                   href="${pageContext.request.contextPath}/BirreListServlet">Reset</a>
            </form>
        </div>
    </div>
</nav>
