...
<nav class="navbar navbar-expand-lg bg-body-tertiary rounded-3 shadow-sm mb-3">
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center gap-2">
            <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/StiliCreateServlet?action=nuovo">
                <i class="fa fa-plus-circle"></i> Aggiungi Stile
            </a>
        ...
        <div class="collapse navbar-collapse mt-2 mt-lg-0" id="prodFilters">
            ...
            <form class="ms-auto d-flex gap-2 align-items-center"  method="GET" action="${pageContext.request.contextPath}/StiliListServlet">               
                ...
                <a class="btn btn-outline-secondary btn-sm"
                   href="${pageContext.request.contextPath}/StiliListServlet">Reset</a>
            </form>
        </div>
    </div>
</nav>
